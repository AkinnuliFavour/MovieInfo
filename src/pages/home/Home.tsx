...
import { ChevronRight, Play, Info, ChevronDown } from "lucide-react";
...
const Home = () => {
  ...
  return (
    <main className="min-h-screen bg-background text-white font-sans selection:bg-primary/30">
      ...
      <section className="relative h-screen w-full overflow-hidden">
              ...
              <>
                ...
                <div className="flex flex-wrap gap-4">
                  <Button
                    ...
                    onClick={() =>
                      navigate(`/movie-details/${featuredMovie.id}`)
                    }
                  >
        ...
        <div className="absolute right-6 bottom-8 z-10">
          <button
            ...
            className="p-3 rounded-full bg-white/10 backdrop-blur-sm hover:bg-white/20 transition-all duration-300 animate-bounce"
      ...
      <section className="container mx-auto px-6 py-16" ref={moviesSectionRef}>
