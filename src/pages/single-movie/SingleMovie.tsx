...
import { Play, Star, Calendar, Clock, Bookmark, Share2 } from "lucide-react";
...
const SingleMovie = () => {
  ...
  const trailer = movieVideos?.data.results.find(v => v.type === "Trailer" && v.site === "YouTube");
        ...
        <div className="container relative mx-auto h-full flex flex-col justify-end px-6 pb-12">
          <div className="max-w-4xl animate-fade-in-up">
            ...
            <div className="flex flex-wrap gap-4">
              ...
              >
                <Bookmark className={`h-5 w-5 ${isInWatchlistState ? "fill-current" : ""}`} />
      ...
      <div className="container mx-auto px-6 py-12 grid grid-cols-1 lg:grid-cols-3 gap-12">
        ...
        <div className="lg:col-span-2 space-y-12">
          ...
          <section className="animate-fade-in-up" style={{ animationDelay: "300ms" }}>
            ...
            {id && movieDetails && <RatingsReviews movieId={Number(id)} movieTitle={movieDetails.data.title} />}
          </section>
        </div>
          ...
          <div className="p-6 rounded-2xl bg-white/5 border border-white/10 backdrop-blur-sm">
            ...
            <div className="space-y-4 text-sm">
              <div>
                ...
                <span className="font-medium">{movieDetails?.data.original_title}</span>
              </div>
              <div>
              ...
              <div>
                <span className="block text-gray-400 mb-1">Original Language</span>
                <span className="font-medium uppercase">{movieDetails?.data.original_language}</span>
              </div>
              <div>
                <span className="block text-gray-400 mb-1">Budget</span>
                <span className="font-medium">N/A</span> {/* API doesn't always provide budget in this endpoint */}
              </div>
              <div>
