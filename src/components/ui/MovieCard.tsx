...
const MovieCard: React.FC<MovieCardProps> = ({
  ...
  return (
    <Link
      to={`/movie-details/${id}`}
      className="group relative block h-[400px] w-full overflow-hidden rounded-xl bg-card shadow-cinematic transition-all duration-500 hover:-translate-y-2 hover:shadow-glow"
    >
      {/* Image */}
