...
const RatingsReviews = ({ movieId, movieTitle }: { movieId: number, movieTitle: string }) => {
    ...
    return (
        <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6 mt-8">
            <h2 className="text-2xl font-bold mb-6 text-gray-900 dark:text-white">Reviews for {movieTitle}</h2>

            {/* Rating Input */}
            <form onSubmit={handleSubmit} className="mb-8 border-b border-gray-200 dark:border-gray-700 pb-8">
                <div className="flex items-center gap-2 mb-4">
                    <span className="text-lg font-medium text-gray-700 dark:text-gray-300">Rate this movie:</span>
